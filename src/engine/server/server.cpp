...
int main(int argc, const char **argv) // ignore_convention
{
    ...
    // Add special votes and disable player collision and hooking
    {
        ...
        pConsole->ExecuteLine("add_svote \"~~~~~~Vote Menu~~~~~~\"");
        pConsole->ExecuteLine("add_svote \"~~~~~~~~~~~~~~~~~~\"");
        pConsole->ExecuteLine("add_svote \"\"");
        pConsole->ExecuteLine("add_svote \"Informations about the mod\"");
        pConsole->ExecuteLine("add_svote \"Help\"");
        pConsole->ExecuteLine("add_svote \"\"");
        pConsole->ExecuteLine("add_svote \"Set wave to x\"");
        pConsole->ExecuteLine("add_svote \"\"");
        pConsole->ExecuteLine("add_svote \"~~~Shop~~~\"");
        pConsole->ExecuteLine("add_svote \"Get ninja - 10 points\"");
        pConsole->ExecuteLine("add_svote \"Get all weapons - 15 points\"");
        pConsole->ExecuteLine("add_svote \"Get more health - 15 points per health\"");
        pConsole->ExecuteLine("add_svote \"Increase your damage on monsters - 50 points per extra damage\"");
        pConsole->ExecuteLine("add_svote \"Health and armor regeneration - 20 points\"");
        pConsole->ExecuteLine("add_svote \"Get automatic shooting - 20 points\"");
        pConsole->ExecuteLine("add_svote \"Get mines - 30 points\"");
        pConsole->ExecuteLine("add_svote \"Get infinite ammo - 30 points\"");
        pConsole->ExecuteLine("add_svote \"Get the vampirism, drain monsters health and armor - 40 points\"");
        pConsole->ExecuteLine("add_svote \"Get spread shots - 50 points\"");
        pConsole->ExecuteLine("add_svote \"Get faster shooting - 50 points\"");
        pConsole->ExecuteLine("add_svote \"Get the protector - 60 points\"");
        pConsole->ExecuteLine("add_svote \"Reflect the half of damage that you receive - 60 points\"");
        pConsole->ExecuteLine("add_svote \"Get the powerful weapons - You need all the shop - 100 points\"");
        pConsole->ExecuteLine("add_svote \"\"");
        pConsole->ExecuteLine("add_svote \"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\"");
