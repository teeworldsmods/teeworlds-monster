...
MACRO_CONFIG_INT(SvInactiveKickTime, sv_inactivekick_time, 180, 0, 1000, CFGFLAG_SERVER, "How many minutes to wait before taking care of inactive players")
...
MACRO_CONFIG_INT(SvMaxWalls, sv_max_walls, 2, -1, 1000, CFGFLAG_SERVER, "The max amount of walls a player can set, -1: infinite")
MACRO_CONFIG_INT(SvWallDamage, sv_wall_damage, 10, -1, 10000, CFGFLAG_SERVER, "Damage monsters get by touching a wall; -1 for instant kill")
MACRO_CONFIG_INT(SvMaxWallKills, sv_max_wall_kills, 10, -1, 1000, CFGFLAG_SERVER, "The max amount of kills until the wall is reseted, -1: infinite")
MACRO_CONFIG_INT(SvWallCosts, sv_wall_costs, 10, 0, 10, CFGFLAG_SERVER, "The amount of armor needed to set a wall")
MACRO_CONFIG_INT(SvMaxMines, sv_max_mines, 20, -1, 1000, CFGFLAG_SERVER, "The max amount of mines a player can set, -1: infinite")
MACRO_CONFIG_INT(SvMineLifetime, sv_mine_lifetime, 30, 0, 1000, CFGFLAG_SERVER, "The lifetime of a mine in seconds")
MACRO_CONFIG_INT(GodMode, godmode, 0, 0, 1, CFGFLAG_SERVER, "No damage for one wave")
MACRO_CONFIG_INT(SvUndead, sv_undead, 0, 0, 1, CFGFLAG_SERVER, "If you respawn after a Monster killed you")
MACRO_CONFIG_INT(SvDeathAnimation, sv_animate_death, 1, 0, 1, CFGFLAG_SERVER, "Wether there is an animation for killing monsters")
